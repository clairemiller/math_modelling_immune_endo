...
from parse_auto import extract_data, parse_fort9
import auto
...
def run_2d_bifurcation(system_chosen):
    ...
    # Data directory
    data_dir = Path("../../output/bifurcation/codimensional",system_chosen+"rho0") # extra .. as we run from two_parameter_auto_files directory
    ...
    fort9_df_fwd = parse_fort9(downsample=300)
    ...
    hb1_forward = run(hb1_start, IPS=2,
                    ...
                    SP = ['BP1'])
    fort9_df_fwd = parse_fort9(downsample=10)
    ...
    loci_2 = run(lpstart, NMX=100000, NPR=1000000, 
                ...
                EPSL = 1e-4, EPSU = 1e-4, EPSS = 1e-2,
                SP = ['BP2'])
    fort9_df_bwd = parse_fort9(downsample=10)
    ...
    fort9_df_fwd = parse_fort9(downsample=200)
    lp1_twoDim_bwd = run(lp1, DS= -1e-2  )
    fort9_df_bwd = parse_fort9(downsample=500)
    ...
    fort9_df_bwd = parse_fort9(downsample=300)
    ...
    fort9_df_fwd = parse_fort9(downsample=50)
...
def main():
    ...
    auto_files_dir = "two_parameter_auto_files/"
